...
### changed: 
####  время между постоянным запросами ~150 ms
####  время между  запросами записи параметров ~500 ms

### added: контроль записанных параметров: warning ,alarm, alarm2,add, dimension,scaleMax
