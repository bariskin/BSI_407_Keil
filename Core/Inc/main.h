...
#define LED7_Pin LL_GPIO_PIN_0
#define LED7_GPIO_Port GPIOB
#define LED8_Pin LL_GPIO_PIN_1
#define LED8_GPIO_Port GPIOB
#define LED9_Pin LL_GPIO_PIN_2
#define LED9_GPIO_Port GPIOB
#define LED10_Pin LL_GPIO_PIN_11
#define LED10_GPIO_Port GPIOF
#define KN1_Pin LL_GPIO_PIN_14
#define KN1_GPIO_Port GPIOF
#define KN2_Pin LL_GPIO_PIN_15
#define KN2_GPIO_Port GPIOF
#define RX_disp_Pin LL_GPIO_PIN_8
#define RX_disp_GPIO_Port GPIOD
#define TX_disp_Pin LL_GPIO_PIN_9
#define TX_disp_GPIO_Port GPIOD
#define TX_debug_Pin LL_GPIO_PIN_6
#define TX_debug_GPIO_Port GPIOC
#define RX_debug_Pin LL_GPIO_PIN_7
#define RX_debug_GPIO_Port GPIOC
#define UART4_RD_Pin LL_GPIO_PIN_11
#define UART4_RD_GPIO_Port GPIOA
#define USART2_RD_Pin LL_GPIO_PIN_12
