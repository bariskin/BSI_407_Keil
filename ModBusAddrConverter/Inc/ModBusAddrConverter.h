...
#define CALIBRATION_PROCESS_STATUS_INTERN            (uint16_t)(35) 

//#define CALIBRATION_PRIMARY_ZERO_VALUE_HIGH_INTERN   (uint16_t)(27)  
//#define CALIBRATION_PRIMARY_ZERO_VALUE_LOW_INTERN    (uint16_t)(28) 
//#define CALIBRATION_PRIMARY_ZERO_INTERN              (uint16_t)(29)  
//#define CALIBRATION_PRIMARY_ZERO_STATUS_INTERN       (uint16_t)(30)  
 
//#define CALIBRATION_PRIMARY_SPAN_VALUE_HIGH_INTERN   (uint16_t)(31)  
//#define CALIBRATION_PRIMARY_SPAN_VALUE_LOW_INTERN    (uint16_t)(32)  
//#define CALIBRATION_PRIMARY_SPAN_INTERN              (uint16_t)(33)  
//#define CALIBRATION_PRIMARY_SPAN_STATUS_INTERN       (uint16_t)(34)  
