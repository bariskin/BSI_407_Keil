...
/**
  * @brief  Convert modbus address for master holding registers
  * @param  MBAddress: External modbus register address
...
uint16_t convertModBusAddrHolding_M(uint16_t MBAddress)
{
    ...
    {     
        ...
        case CALIBRATION_PROCESS_STATUS + 1:
        ...
        default:
            /* No conversion needed, return original address */
            MBReg = MBAddress;
            break;
    }
...
/**
  * @brief  Convert modbus address for master input registers
  * @param  MBAddress: External modbus register address
  * @retval Internal address of the Modbus SyncMan register
  */
...
/**
  * @brief  Convert modbus address for slave holding registers
  * @param  MBAddress: External modbus register address
  * @retval Internal address of the Modbus SyncMan register
  */
...
/**
  * @brief  Convert modbus address for slave input registers
  * @param  MBAddress: External modbus register address
  * @retval Internal address of the Modbus SyncMan register
  */
